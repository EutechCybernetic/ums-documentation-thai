...
คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูส่วนต่อประสานของการวิเคราะห์เต็มหน้า
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทสาธารณูปโภคที่รู้จักแล้วจึงไม่มีตัวเลือกนี้ในกรณีเหล่านั้น
...
ในการทำสิ่งนี้ - ก่อนอื่นเลือกเป้าหมายเดียว
...
เมื่อคุณเพิ่มเป้าหมาย, วิดเจ็ตจะรีเฟรชเพื่อแสดงเป้าหมายที่อัปเดตใหม่เป็นแท่งใหม่หรือคอลัมน์หรือเหลี่ยมในแผนภูมิ

### ถัง

โดยค่าเริ่มต้น, ข้อมูลจะถูกเลือกตามช่วงวันที่และตัวกรองอื่น ๆ และสะสมเป็นช่วงเวลา 1 วัน
...
ถัง **Week** แสดงจุดข้อมูลหนึ่งสำหรับทุกสัปดาห์ โปรดทราบว่าสัปดาห์ไม่ได้หมายถึง '7 วัน' แต่หมายถึง 'หนึ่งสัปดาห์'
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน ฯลฯ) คุณยังสาม