...
เครื่องมือวิเคราะห์การบริโภคให้คุณมีส่วนต่อประสานเพื่อวิเคราะห์การบริโภคของวัตถุใด ๆ (เมตร, กลุ่ม หรือแท็ก) ในหลายรูปแบบ

{% hint style="info" %}
เมื่อเราพูดถึง 'วัตถุ' เราหมายถึงเมตร, เมตรเสมือนจริง, กลุ่มเมตร หรือแท็ก
{% endhint %}

เครื่องมือนี้สามารถใช้งานได้ในหลายทาง:
...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุที่เฉพาะเจาะจง อาจมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีที่คุณเรียกใช้เครื่องมือ
2. แผงวิเคราะห์
3. ตัวกรองวันที่ - คุณสามารถเลือกช่วงวันที่เพื่อวิเคราะห์การบริโภค
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้าเกี่ยวข้อง) ความคลาดเคลื่อนรวมจากเส้นฐาน
   1. คุณสามารถส่งออกข้อมูลที่กำลังดูได้ทุกเวลาโดยใช้ปุ่มส่งออก มันจะดาวน์โหลดข้อมูลส่งออก csv ของข้อมูล
5. แผงตัวกรอง - คลิกที่นี่เพื่อขยายเครื่องมือเพื่อแสดงตัวกรองที่มีทั้งหมด
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี้ใช้เฉพาะกับเมตรเสมือนจริงและกลุ่มเมตร
...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถทำได้เฉพาะเมื่อคุณเลือกช่วงวันที่ที่เกี่ยวข้อง - เพื่อให้เครื่องมือทราบวันที่สำหรับเธอด้วย
{% endhint %}
...
นี่คล้ายกับส่วนต่อประสานก่อนหน้านี้ แต่มีตัวเลือกมากขึ้น
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทยูทิลิตี้ทราบแล้วดังนั้นตัวเลือกนั้นจึงไม่สามารถใช้งานได้ในกรณีเหล่านั้น
...
เมื่อคุณเพิ่มเป้าหมาย, วิดเจ็ตจะรีเฟรชเพื่อแสดงเป้าหมายที่อัปเดตเป็นแท่งใหม่หรือคอลัมน์หรือชิ้นส่วนในแผนภูมิ
...
ถัง **ปี** จะจัดกลุ่มข้อมูลสำหรับทั้งปี
...
เมื่อจุดข้อมูลถูกจัดกลุ่ม, ข้อมูลทั้งหมดจะถูกรวมด้วยกันและแสดงในจุดข้อมูลนั้น
