...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุที่เฉพาะเจาะจง นี่อาจจะมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีที่คุณเรียกใช้เครื่องมือ
2. แผงวิเคราะห์
...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี่เป็นสิ่งที่เกี่ยวข้องเฉพาะกับเมตรเสมือนจริงและกลุ่มเมตรเท่านั้น
...
คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูเต็มของอินเตอร์เฟซการวิเคราะห์
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทยูทิลิตี้ทราบแล้วดังนั้นตัวเลือกนั้นจะไม่มีในกรณีเหล่านั้น
...
คุณสามารถเลือกแท็กหลาย ๆ แท็กและข้อมูลที่แสดงจะเป็นจาก _ส่วนร่วม_ ของทุกแท็ก
...
{% hint style="info" %}
แท็กย่อยจะถูกพิจารณาด้วยเนื่องจากการบริโภคของแต่ละแท็กรวมการบริโภคจากแท็กย่อยด้วย
{% endhint %}
...
การเพิ่มนี้เรียกว่า _ถัง_ มีถังอื่น ๆ ที่มีอยู่:
