...
{% hint style="info" %}
การเปรียบเทียบช่วงเวลาปัจจุบันกับช่วงเวลาก่อนหน้านี้สามารถทำได้เฉพาะเมื่อคุณเลือกช่วงวันที่สัมพันธ์ - ดังนั้นเครื่องมือจะรู้ว่าวันที่สำหรับเธอยังมีอีก
{% endhint %}
...
แผงตัวกรองให้คุณมีช่วงการกรองและการจัดกลุ่มและตัวเลือกการรวมข้อมูลสำหรับข้อมูล
...
คุณจะถูกขอให้เลือกประเภทแท็กก่อน แล้วจึงนำเสนอแท็กต้นไม้เพื่อเลือกแท็กของคุณ
...
**ถังวัน** จะแสดงจุดข้อมูลหนึ่งต่อวัน&#x20;

**ถังสัปดาห์** แสดงจุดข้อมูลหนึ่งสำหรับทุกสัปดาห์ โปรดทราบว่าสัปดาห์ไม่ได้หมายความว่า '7 วัน' แต่หมายความว่า 'หนึ่งสัปดาห์'
...
**ถังเดือน** จะจัดกลุ่มข้อมูลเป็นจุดข้อมูลหนึ่งสำหรับทุกเดือนของปี

**ถังปี** จะจัดกลุ่มข้อมูลสำหรับทั้งปี
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน ฯลฯ) คุณยังสามารถวิเคราะห์ข้อมูลโดย 3 กลุ่มต