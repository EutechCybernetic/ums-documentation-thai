...
เครื่องมือวิเคราะห์การบริโภคให้คุณมีส่วนต่อประสานเพื่อวิเคราะห์การบริโภคของวัตถุใด ๆ (เมตร, กลุ่ม หรือแท็ก) ในหลากหลายวิธี
...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุเฉพาะ สิ่งนี้อาจมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีที่คุณเรียกใช้เครื่องมือ
2. แผงวิเคราะห์
...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถทำได้เฉพาะเมื่อคุณเลือกช่วงวันที่ที่เกี่ยวข้อง - ดังนั้นเครื่องมือจะทราบวันที่สำหรับเธอด้วย
{% endhint %}
...
2. แผงตัวกรองทางด้านขวาที่ให้คุณตัวเลือกตัวกรองมากขึ้น
...
ถ้าคุณเลือก 'เมตรยูทิลิตี้' เป็นประเภทเป้าหมาย, คุณสามารถเลือกเมตรยูทิลิตี้ที่คุณต้องการวิเคราะห์ คุณสามารถเลือกเมตรยูทิลิตี้หลายตัวด้วย

#### เมตรเสมือนจริง

ถ้าคุณเลือก 'เมตรเสมือนจริง' เป็นประเภทเป้าหมาย, คุณสามารถเลือกเมตรเสมือนจริงที่คุณต้องการวิเคราะห์ คุณสามารถเลือกเมตรเสมือนจริงหลายตัวด้วย
...
คุณสามารถเลือกแท็กหลายตัวและข้อมูลที่แสดงจะเป็นจาก _การตัดกัน_ ของแท็กทั้งหมด
...
เมื่อคุณเพิ่มเป้าหมาย, วิดเจ็ตจะถูกรีเฟรชเพื่อแสดงเป้าหมายที่อัปเดตเป็นแท่งใหม่หรือคอลัมน์หรือแผ่นในแผนภูมิ
...
ถัง **15 นาที** จะแสดงข้อมูลในช่วง 15 นาที หมายความว่าสำหรับทุกชั่วโมง, มันจะแสดง 4 ค่า:
...
ถัง **สัปดาห์** แสดงจุดข้อมูลหนึ่งสำหรับทุกสัปดาห์ โปรดทราบว่าสัปดาห์ไม่หมายความว่า '7 วัน' แต่มันหมายความว่า 'หนึ่งสัปดาห์'
