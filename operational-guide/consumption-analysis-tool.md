...
เครื่องมือวิเคราะห์การบริโภคให้คุณมีส่วนต่อประสานงานเพื่อวิเคราะห์การบริโภคของวัตถุใด ๆ (เมตร, กลุ่ม หรือแท็ก) ในหลาย ๆ วิธี
...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุเฉพาะ ซึ่งอาจจะมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีการเรียกใช้เครื่องมือ
2. แผงวิเคราะห์
...
คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูมุมมองเต็มของส่วนต่อประสานงานวิเคราะห์

<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption></figcaption></figure>

สิ่งนี้คล้ายกับส่วนต่อประสานงานก่อนหน้านี้ แต่มีตัวเลือกที่มากขึ้น
...
{% hint style="info" %}
ตัวเลือกนี้สามารถใช้ได้เฉพาะเมื่อคุณเข้าถึงเครื่องมือวิเคราะห์การบริโภคจากวิดเจ็ตแดชบอร์ด
{% endhint %}
...
{% hint style="info" %}
ตัวเลือกนี้สามารถใช้ได้เฉพาะเมื่อคุณเข้าถึงเครื่องมือวิเคราะห์การบริโภคจากวิดเจ็ตแดชบอร์ดและหลังจากที่คุณเลือก 'ประเภทเป้าหมาย'
{% endhint %}
...
ในการทำเช่นนั้น - เลือกเป้าหมายเดียวก่อน
...
นอกจากการแสดงข้อมูลตามวันที่จริง