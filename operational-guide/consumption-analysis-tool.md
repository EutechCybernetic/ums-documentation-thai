...
4. KPI ระดับสูง - แสดงการบริโภคสูงสุดในปัจจุบันและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนรวมจากเส้นฐาน
   1. คุณสามารถส่งออกข้อมูลที่กำลังดูได้ทุกเวลาโดยใช้ปุ่มส่งออก มันจะดาวน์โหลดการส่งออก csv ของข้อมูล
5. แผงกรอง - คลิกที่นี่เพื่อขยายเครื่องมือเพื่อแสดงตัวกรองที่มีทั้งหมด
...
คุณสามารถคลิกที่ไอคอน 'กรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูส่วนต่อประสานการวิเคราะห์แบบเต็ม
...
2. แผงกรองทางด้านขวาที่ให้คุณมีตัวเลือกกรองที่มากขึ้น

## ตัวเลือกการกรอง

แผงกรองให้คุณมีช่วงตัวเลือกการกรองและการจัดกลุ่มและตัวเลือกการรวมข้อมูลสำหรับข้อมูล
...
คุณสามารถเลือกแท็กหลาย ๆ ตัวและข้อมูลที่แสดงจะเป็นจาก _การตัดกัน_ ของแท็กทั้งหมด
...
ถัง **Year** จัดกลุ่มข้อมูลสำหรับปีทั้งหมด
