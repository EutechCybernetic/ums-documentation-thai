...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- สิ่งนี้เกี่ยวข้องเฉพาะกับเมตรเสมือนและกลุ่มเมตรเท่านั้น
...
คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภูมิด้านบน) เพื่อขยายเพื่อดูภาพรวมของส่วนต่อประสานการวิเคราะห์

<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption></figcaption></figure>

สิ่งนี้คล้ายกับส่วนต่อประสานที่ก่อนหน้านี้ แต่มีตัวเลือกที่มากขึ้น

1. ความสามารถในการเปลี่ยนประเภทของการแสดงผล คุณสามารถเลือกระหว่าง
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทสาธารณูปโภคที่รู้จักแล้วดังนั้นตัวเลือกนั้นจะไม่สามารถใช้งานได้ในกรณีเหล่านั้น
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน ฯลฯ) คุณยังสามารถวิเคราะห์ข้อมูลโดย 3 กลุ่มที่