...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุที่เฉพาะเจาะจง นี้อาจจะมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีการเรียกใช้เครื่องมือ
2. แผงการวิเคราะห์
3. ตัวกรองวันที่ - คุณสามารถเลือกช่วงวันที่เพื่อวิเคราะห์การบริโภค
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนทั้งหมดจากเส้นฐาน
   1. คุณสามารถส่งออกข้อมูลที่กำลังดูได้เมื่อใดก็ตามโดยใช้ปุ่มส่งออก มันจะดาวน์โหลดการส่งออก csv ของข้อมูล
...
{% hint style="info" %}
การเปรียบเทียบช่วงเวลาปัจจุบันกับช่วงเวลาก่อนหน้านี้สามารถใช้ได้เฉพาะเมื่อคุณเลือกช่วงวันที่ที่เกี่ยวข้อง - ดังนั้นเครื่องมือจะทราบวันที่สำหรับเธอด้วย
{% endhint %}
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทยูทิลิตี้จะรู้แล้วดังนั้นตัวเลือกนี้จะไม่สามารถใช้ได้ในกรณีเหล่านั้น
...
คุณสามารถเลือกแท็กหลาย ๆ แท็กและข้อมูลที่แสดงจะเป็นจาก _ส่วนต่อประสาน_ ของทุก ๆ แท็ก
...
**Year** ถังจับกลุ่มข้อมูลสำหรับทั้งปี
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน ฯลฯ) ค