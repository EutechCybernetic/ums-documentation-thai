...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุเฉพาะ นี่อาจเป็นหรือไม่เป็นที่มองเห็นขึ้นอยู่กับวิธีการเรียกใช้เครื่องมือ
2. แผงวิเคราะห์
3. ตัวกรองวันที่ - คุณสามารถเลือกช่วงวันที่เพื่อวิเคราะห์การบริโภค
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคที่มากที่สุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนรวมจากเบสไลน์
...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี่เกี่ยวข้องเฉพาะกับเมตรเสมือนจริงและกลุ่มเมตร
...
แผงตัวกรองให้คุณมีช่วงของตัวเลือกการกรองและการจัดกลุ่มและตัวเลือกการรวมข้อมูลสำหรับข้อมูล
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทยูทิลิตี้จะรู้แล้วดังนั้นตัวเลือกนั้นจึงไม่สามารถใช้งานได้ในกรณีเหล่านั้น

### หน่วย

ขึ้นอยู่กับประเภทของยูทิลิตี้ - รายการของหน่วยที่เป็นไปได้จะถูกแสดงด้วยหน่วยฐานเริ่มต้นที่เลือก
...
คุณสามารถเลือกแท็กหลาย ๆ ตัวและข้อมูลที่แสดงจะเป็นจาก _การตัดกัน_ ของทุก ๆ แท็ก
