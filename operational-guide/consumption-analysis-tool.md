...
เครื่องมือนี้สามารถใช้งานได้หลายวิธี:
...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี้เฉพาะสำหรับเมตรเสมือนจริงและกลุ่มเมตรเท่านั้น
...
คลิกที่วันที่เริ่มต้นในปฏิทินก่อน แล้วคลิกวันที่สิ้นสุด- ปฏิทินควรจะเน้นทุกวันที่ระหว่างวันที่เริ่มต้นและวันที่สิ้นสุด

{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้จะมีเฉพาะเมื่อคุณเลือกช่วงวันที่สัมพันธ์ - ดังนั้นเครื่องมือจะทราบวันที่สำหรับเธอด้วย
{% endhint %}
...
1. ความสามารถในการเปลี่ยนประเภทการแสดงผล คุณสามารถเลือกระหว่าง
   ...
   2. แผนภูมิคอลัมน์ (แท่งเรียงแนวนอน)
   3. แผนภูมิพื้นที่
   4. แผนภูมิเส้น
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก ประเภทยูทิลิตี้จะทราบแล้วดังนั้นตัวเลือกนั้นจะไม่มีในกรณีเหล่านั้น
...
คุณสามารถเปรียบเทียบหลายรายการ (ที่เรียกว่า 'เป้าหมาย')
...
ที่แผงด้านซ้าย แสดงรายการของเป้าหมายเพิ่มเติม
...
การเพิ่มนี้เรียกว่า _ถัง_ มีถังอื่น ๆ ที่มีให้:
