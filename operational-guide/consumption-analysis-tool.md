...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุที่เฉพาะเจาะจง นี้อาจจะมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีที่คุณเรียกใช้เครื่องมือ
2. แผงการวิเคราะห์
3. ตัวกรองวันที่ - คุณสามารถเลือกช่วงวันที่เพื่อวิเคราะห์การบริโภค
4. KPIs ระดับสูง - ปัจจุบันแสดงการบริโภคที่มากที่สุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนทั้งหมดจากเส้นฐาน
...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี้เป็นไปได้เฉพาะกับเมตรเสมือนจริงและกลุ่มเมตร
...
คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูส่วนต่อประสานการวิเคราะห์แบบเต็ม
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทยูทิลิตี้ที่รู้จักแล้วดังนั้นตัวเลือกนั้นจะไม่มีในกรณีเหล่านั้น
...
**15 นาที** ถังจะแสดงข้อมูลในช่วงเวลา 15 นาที หมายความว่าสำหรับทุก ๆ ชั่วโมง, มันจะแสดง 4 ค่า:

3:00, 3:15, 3:30, 3:45 (ถ้าเป็นช่วงเวลา 3 โมง)

**30 นาที** ถังจะแสดงข้อมูลในช่วงเวลา 30 นาที - 3:00 และ 3:30
...
{% hint style="info" %}
ถ้าคุณต้องการดูการบริโภคสะสมทั้งหมดเป็นตัวเลขเดียว, เลือก 'ปี' เป็นวิธีที่ดีเพราะมันจะรวมข้อมูลทั้งหมดสำหรับทั้งปี
{% endhint %}
