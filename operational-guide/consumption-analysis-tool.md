...
เครื่องมือวิเคราะห์การบริโภคให้คุณมีอินเตอร์เฟซในการวิเคราะห์การบริโภคของวัตถุใด ๆ (เมตร, กลุ่ม หรือแท็ก) ในหลาย ๆ วิธี
...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี้เกี่ยวข้องเฉพาะกับเมตรเสมือนจริงและกลุ่มเมตรเท่านั้น
...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถทำได้เฉพาะเมื่อคุณเลือกช่วงวันที่เทียบเท่า - เพื่อให้เครื่องมือรู้วันที่สำหรับเธอด้วย
{% endhint %}

## ตัวกรองและการวิเคราะห์ขยาย

คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูอินเตอร์เฟซวิเคราะห์เต็มรูปแบบ

<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption></figcaption></figure>

นี่คล้ายกับอินเตอร์เฟซก่อนหน้านี้ แต่มีตัวเลือกเพิ่มเติม
...
2. แผงตัวกรองที่ด้านขวาที่ให้คุณตัวเลือกตัวกรองเพิ่มเติม
...
เมื่อคุณเข้าถึงเครื่องมือจากเมตรหรือแท็ก, ประเภทยูทิลิตี้จะรู้แล้วเพราะฉะนั้นตัวเลือกนั้นจะไม่มีในกรณีเหล่านั้น
...
บนแผงด้านซ้าย, แสดงรายการเป้าหมายเพิ่มเติม
...
โดยค่าเริ่มต้น, ข้อมูลถูกเลือกตามช่วงวันที่และตัวกรองอื่น ๆ และสะสมเป็นช่วงเพิ่มขึ้น 1 วัน

ช่วงเพิ่มขึ้นนี้เรียกว่า _ถัง_ มีถังอื่น ๆ ที่มีให้:
...
ถ้าคุณอยู่กลางสัปดาห์ (เช่น, วันอังคาร) - มันจะแสดงข้อมูลจากวันอาทิตย์ถึงวันอังคารสำหรับสัปดาห์นั้น สำหรับสัปดาห์ก่อนหน้านี้มันจะแสดงข้อมูลจากวันอาทิตย์ถึงวันเสาร์
...
{% hint style="info" %}
ถ้าคุณต้องการดูการบริโภคสะสมรวมเป็นตัวเลขเดียว, การเลือก 'ปี' เป็นวิธีที่ดีเพราะมันจะรวมข้อมูลทั้งหมดสำหรับทั้งปี
{% endhint %}
