...
เครื่องมือวิเคราะห์การบริโภคให้คุณมีอินเทอร์เฟซในการวิเคราะห์การบริโภคของวัตถุใด ๆ (เมตร, กลุ่ม หรือแท็ก) ในหลาย ๆ วิธี
...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุเฉพาะ อาจมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีที่คุณเรียกใช้เครื่องมือ
2. แผงการวิเคราะห์
3. ตัวกรองวันที่ - คุณสามารถเลือกช่วงวันที่เพื่อวิเคราะห์การบริโภค
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนรวมจากเบสไลน์
...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถทำได้เฉพาะเมื่อคุณเลือกช่วงวันที่สัมพันธ์ - ดังนั้นเครื่องมือจะรู้ว่าวันที่สำหรับเธอยังมีอีก
{% endhint %}

## ตัวกรองและการวิเคราะห์ขั้นสูง

คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายไปยังมุมมองเต็มของอินเทอร์เฟซการวิเคราะห์

<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption></figcaption></figure>

นี่คล้ายกับอินเทอร์เฟซก่อนหน้านี้ แต่มีตัวเลือกเพิ่มเติม
...
เมื่อคุณเลือกเป้าหมาย, คุณจะมีตัวเลือกในการเลือกเป้าหมายเพิ่มเติมเพื่อเปรียบเทียบ
...
ถัง **วัน** จะแสดงจุดข้อมูลเดียวต่อวัน&#x20;
...
ถัง **เดือน** จะจัดกลุ่มข้อมูลเป็นจุดข้อมูลเดียวสำหรับทุกเดือนของปี
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน ฯลฯ) คุณยังสามารถวิเคราะห์ข้อมูลโดย 3 กล