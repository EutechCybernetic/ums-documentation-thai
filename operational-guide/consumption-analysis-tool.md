...
คลิกครั้งแรกที่วันที่เริ่มต้นในปฏิทิน, แล้วคลิกที่วันที่สิ้นสุด- ปฏิทินควรจะเน้นวันที่ทั้งหมดระหว่างวันที่เริ่มต้นและวันที่สิ้นสุด

{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถใช้ได้เฉพาะเมื่อคุณเลือกช่วงวันที่ที่เกี่ยวข้อง - ดังนั้นเครื่องมือจะทราบวันที่สำหรับเธอด้วย
{% endhint %}
...
โดยค่าเริ่มต้น, ข้อมูลถูกเลือกตามช่วงวันที่และตัวกรองอื่น ๆ และสะสมเป็นการเพิ่มขึ้นทีละ 1 วัน
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน ฯลฯ) คุณย