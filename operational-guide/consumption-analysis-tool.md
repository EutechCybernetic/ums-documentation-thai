...
เครื่องมือนี้สามารถเรียกใช้ได้หลายวิธี:
...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุเฉพาะ นี่อาจจะมองเห็นหรือไม่มองเห็นขึ้นอยู่กับว่าคุณเรียกใช้เครื่องมืออย่างไร
2. แผงวิเคราะห์
...
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนรวมจากเส้นฐาน
   1. คุณสามารถส่งออกข้อมูลที่ดูได้เมื่อใดก็ได้โดยใช้ปุ่มส่งออก มันจะดาวน์โหลดการส่งออก csv ของข้อมูล
...
{% hint style="info" %}
การเปรียบเทียบช่วงเวลาปัจจุบันกับช่วงเวลาก่อนหน้านี้สามารถใช้ได้เฉพาะเมื่อคุณเลือกช่วงวันที่สัมพันธ์ - ดังนั้นเครื่องมือจะทราบวันที่สำหรับเธอด้วย
{% endhint %}
...
{% hint style="info" %}
ถ้าคุณต้องการดูการบริโภคสะสมทั้งหมดเป็นตัวเลขเดียว, เลือก 'ปี' เป็นวิธีที่ดีที่สุดในการทำเช่นนั้นเนื่องจากมันจะรวมข้อมูลทั้งหมดสำหรับทั้งปี
{% endhint %}
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน ฯลฯ) คุณยังสามารถวิเคราะห์ข้อมูล