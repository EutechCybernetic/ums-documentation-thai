...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุเฉพาะ สิ่งนี้อาจจะมองเห็นหรือไม่ได้ ขึ้นอยู่กับวิธีการเรียกใช้เครื่องมือ
2. แผงการวิเคราะห์
3. ตัวกรองวันที่ - คุณสามารถเลือกช่วงวันที่เพื่อวิเคราะห์การบริโภค
4. KPIs ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนทั้งหมดจากเส้นฐาน
...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถใช้ได้เฉพาะเมื่อคุณเลือกช่วงวันที่สัมพันธ์ - ดังนั้นเครื่องมือจะรู้ว่าวันที่สำหรับเธอยังมีอีก
{% endhint %}
...
ไม่ใช่ทุกตัวกรองที่สามารถใช้ได้เสมอ
...
สำหรับสัปดาห์ก่อนหน้านั้นจะแสดงข้อมูลจากวันอาทิตย์ถึงวันเสาร์
