...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถทำได้เฉพาะถ้าคุณเลือกช่วงวันที่ที่เกี่ยวข้อง - เพื่อให้เครื่องมือทราบวันที่สำหรับเธอด้วย
{% endhint %}
...
2. แผงตัวกรองที่ด้านขวาให้คุณตัวเลือกตัวกรองเพิ่มเติม
...
โดยใช้ตัวอย่างด้านบน, เมตรที่มีเครื่องหมายถูกสีเขียวจะถูกเลือกโดยใช้การผสมของ Location:Building1 และ System:PlugLoad
...
**ถังวัน** จะแสดงจุดข้อมูลเดียวต่อวัน&#x20;



**ถังสัปดาห์** แสดงจุดข้อมูลเดียวสำหรับทุกสัปดาห์ โปรดทราบว่าสัปดาห์ไม่ได้หมายความว่า '7 วัน' แต่มันหมายถึง 'หนึ่งสัปดาห์'

ถ้าคุณอยู่ในระหว่างสัปดาห์ (เช่น วันอังคาร) - มันจะแสดงข้อมูลจากวันอาทิตย์ถึงวันอังคารสำหรับสัปดาห์นั้น\
สำหรับสัปดาห์ก่อนหน้านั้นจะแสดงข้อมูลจากวันอาทิตย์ถึงวันเสาร์



**ถังเดือน** จะจัดกลุ่มข้อมูลเป็นจุดข้อมูลเดียวสำหรับทุกเดือนของปี



**ถังปี** จัดกลุ่มข้อมูลสำหรับปีทั้งหมด
...
นอกจากการแสดงข้อมูลตามวันที่จริง (หรือชั่วโมงหรือเดือน 