...
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนรวมจากแนวทางพื้นฐาน
...
ช่วงเวลานี้เรียกว่า _bucket_ มีถังอื่น ๆ ที่มีให้เลือก:
...
**Year** ถังจัดกลุ่มข้อมูลสำหรับทั้งปี
...
เมื่อจุดข้อมูลถูกจัดกลุ่ม, ข้อมูลทั้งหมดจะถูกรวมกันและแสดงในจุดข้อมูลนั้น
