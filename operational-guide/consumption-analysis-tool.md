...
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้าเกี่ยวข้อง) ความเบี่ยงเบนรวมจากฐาน
...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี้ใช้ได้เฉพาะกับเมตรเสมือนและกลุ่มเมตร
...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้มีเฉพาะเมื่อคุณเลือกช่วงวันที่ที่เกี่ยวข้อง - ดังนั้นเครื่องมือจะทราบวันที่สำหรับเธอด้วย
{% endhint %}

## ตัวกรองและการวิเคราะห์ที่ขยาย

คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูมุมมองแบบเต็มของส่วนต่อประสานการวิเคราะห์

<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption></figcaption></figure>

นี่คล้ายกับส่วนต่อประสานที่ก่อนหน้านี้ แต่มีตัวเลือกมากขึ้น
...
ไม่ใช่ทุกตัวกรองที่มีประโยชน์เสมอ
...
ถ้าคุณเลือก 'กลุ่มเมตร' เป็นประเภทเป้าหมาย, คุณสามารถเลือกกลุ่มที่คุณต้องการวิเคราะห์ คุณสามารถเลือกหลายกลุ่มเพื่อวิเคราะห์ด้วย
...
คุณสามารถเลือกแท็กหลาย ๆ ตัวและข้อมูลที่แสดงจะเป็นจาก _การตัดกัน_ ของทุกแท็ก
