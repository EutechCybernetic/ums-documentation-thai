...
1. แผงรายละเอียด - มีรายละเอียดเกี่ยวกับวัตถุเฉพาะ ซึ่งอาจมองเห็นหรือไม่มองเห็นขึ้นอยู่กับวิธีการเรียกใช้เครื่องมือ
2. แผงวิเคราะห์
3. ตัวกรองวันที่ - คุณสามารถเลือกช่วงวันที่เพื่อวิเคราะห์การบริโภค
4. KPI ระดับสูง - ปัจจุบันแสดงการบริโภคสูงสุดและ (ถ้ามี) ความเบี่ยงเบนรวมจากเส้นฐาน
...
6. [consumption-contribution-tool.md](consumption-contribution-tool.md "mention")- นี้ใช้ได้เฉพาะกับเมตรเสมือนและกลุ่มเมตรเท่านั้น
...
{% hint style="info" %}
การเปรียบเทียบระยะเวลาปัจจุบันกับระยะเวลาก่อนหน้านี้สามารถทำได้เฉพาะถ้าคุณเลือกช่วงวันที่ที่เกี่ยวข้อง - ดังนั้นเครื่องมือจะทราบวันที่สำหรับเธอด้วย
{% endhint %}

## ตัวกรองและการวิเคราะห์ที่ขยาย

คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูเต็มหน้าจอของส่วนต่อประสานการวิเคราะห์

<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption></figcaption></figure>

นี่คล้ายกับส่วนต่อประสานที่ก่อนหน้านี้ แต่มีตัวเลือกเพิ่มเติม
...
คุณสามารถเลือกแท็กหลายตัวและข้อมูลที่แสดงจะเป็นจาก _intersection_ ของทุกแท็ก
...
คุณสามารถเลือกดูค่าเฉลี่ย, ผลรวม, ค่าต่ำสุดหรือค่าสูงสุดข้ามช่วงเวลานั้น
