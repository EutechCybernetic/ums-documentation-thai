...
เครื่องมือวิเคราะห์การบริโภคให้คุณมีส่วนต่อประสานเพื่อวิเคราะห์การบริโภคของวัตถุใด ๆ (เมตร, กลุ่ม หรือแท็ก) ในหลาย ๆ ทาง
...
คุณสามารถคลิกที่ไอคอน 'ตัวกรอง' ที่ด้านบนขวา (#6 ในแผนภาพด้านบน) เพื่อขยายเพื่อดูวิวเต็มของส่วนต่อประสานการวิเคราะห์

<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption></figcaption></figure>

นี้คล้ายกับส่วนต่อประสานที่ก่อนหน้านี้ แต่มีตัวเลือกที่มากขึ้น
...
เมื่อคุณใช้ตัวเลือกนั้น - คุณจะเห็นหน้าจอที่คุณสามารถเพิ่มเป้าหมายเพิ่มเติม
...
**Month** ถังจับกลุ่มข้อมูลเป็นจุดข้อมูลหนึ่งสำหรับทุกเดือนของปี

**Year** ถังจับกลุ่มข้อมูลสำหรับปีทั้งหมด
