...
ลำดับชั้นของสถานที่ (ที่กำหนดไว้ในแอปพลิเคชัน Location ของ iviva) ยังแสดงอยู่ที่นี่และให้คุณวิเคราะห์ข้อมูลในแต่ละสถานที่ในลำดับชั้น
...
เราได้เลือกดูข้อมูลการบริโภคสำหรับรายการที่ติดแท็ก 'อุปกรณ์' ทั้งหมดที่มีสถานที่เป็น 'Precinct1'
