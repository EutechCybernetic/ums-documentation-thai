...
ลำดับชั้นของสถานที่ (ที่กำหนดไว้ในแอปพลิเคชัน Location ของ iviva) ก็จะแสดงที่นี่ และให้คุณวิเคราะห์ข้อมูลในแต่ละสถานที่ในลำดับชั้น
...
คุณสามารถเลือกแท็กเดียวจากแต่ละประเภทแท็กและดูข้อมูลการบริโภคเกี่ยวกับมัน ถ้าคุณเลือกแท็กแม่ ข้อมูลการบริโภคจะมีข้อมูลที่รวมจากแท็กลูกทั้งหมดด้วย
