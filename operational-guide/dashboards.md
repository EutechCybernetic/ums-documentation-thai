...
วิดเจ็ตนี้ให้คุณมองเห็นภาพรวมของการบริโภคสาธารณูปโภคต่าง ๆ ที่คุณสามารถดูได้ทันที

{% hint style="info" %}
ดู [utility-types.md](../readme/concepts/utility-types.md "mention") สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการกำหนดค่าสาธารณูปโภคต่าง ๆ
{% endhint %}
...
ใช้ฟิลเตอร์สถานที่เพื่อเลือกสถานที่ที่คุณต้องการดูข้อมูลเปรียบเทียบ คุณจะเลือกอาคารหรือไซต์ที่นี่โดยทั่วไป
...
เมื่อคุณทำการเปลี่ยนแปลง ไอคอน 'พิน' จะปรากฏที่มุมบนขวา
...
การเปลี่ยนแปลงนี้จะมีผลสำหรับผู้ใช้ทั้งหมดเมื่อทำในแดชบอร์ดในแอปพลิเคชัน UMS

โปรดทราบว่าคุณสามารถเพิ่มวิดเจ็ตเดียวกันหลายครั้งและแต่ละวิดเจ็ตสามารถมีค่าที่พินที่แตกต่างกันได้