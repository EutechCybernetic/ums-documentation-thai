...
การเข้าสู่โหมด 'แก้ไข' จะทำให้คุณสามารถจัดวิดเจ็ตได้ง่ายขึ้น ปรับแต่งวิดเจ็ต ลบวิดเจ็ต และเพิ่มวิดเจ็ตใหม่
...
มีวิดเจ็ตการเปรียบเทียบเบสไลน์สาธารณูปโภค 2 แบบ แต่ทั้งสองแบบทำงานในทางเดียวกัน

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>

ใช้ฟิลเตอร์สถานที่เพื่อเลือกสถานที่ที่คุณต้องการดูข้อมูลการเปรียบเทียบ คุณจะเลือกอาคารหรือไซต์ที่นี่โดยทั่วไป
