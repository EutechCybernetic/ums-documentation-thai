...
โปรดทราบว่าแดชบอร์ดเหล่านี้ถูกกำหนดค่าโดยผู้ใช้ที่เป็นผู้ดูแลระบบ และสามารถใช้งานได้กับผู้ใช้ทั้งหมดที่มีสิทธิ์เข้าถึงแอปพลิเคชัน UMS
...
แดชบอร์ดเหล่านี้ทำงานเหมือนแดชบอร์ด iviva ปกติ แต่มีความแตกต่างคือการเปลี่ยนแปลงที่ผู้ใช้ทำจะส่งผลถาวรต่อผู้ใช้ทั้งหมดของแอปพลิเคชัน

คุณสามารถเพิ่ม/แก้ไข/ลบวิดเจ็ตใด ๆ ในแดชบอร์ดนี้ได้
...
วิดเจ็ตนี้ให้เครื่องมือวิเคราะห์การใช้งานแบบเต็มรูปแบบ
...
วิดเจ็ตนี้ให้คุณมองเห็นภาพรวมของการใช้งานของประเภทค่าใช้จ่ายต่าง ๆ ได้ทันที
...
มันแสดงการใช้งานรวมสำหรับช่วงเวลาที่กำหนดและสถานที่สำหรับแต่ละค่าใช้จ่าย และวิธีการเปรียบเทียบกับเบสไลน์ที่เลือก



มี 2 รูปแบบของวิดเจ็ตการเปรียบเทียบเบสไลน์ค่าใช้จ่าย แต่ทั้งสองทำงานในแบบเดียวกัน

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>

ใช้ตัวกรองสถานที่เพื่อเลือกสถานที่ที่คุณต้องการดูข้อมูลเปรียบเทียบ คุณโดยทั่วไปจะเลือกอาคารหรือไซต์ที่นี่
...
คุณยังสามารถเลือกเบสไลน์เพื่อเปรียบเทียบและช่วงเวลาเริ่มต้นที่เริ่มต้น
