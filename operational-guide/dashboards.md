...
แดชบอร์ดเหล่านี้ทำงานเหมือนกับแดชบอร์ด iviva ปกติ แต่มีความแตกต่างคือการเปลี่ยนแปลงที่ผู้ใช้ทำจะส่งผลถาวรต่อผู้ใช้ทั้งหมดของแอปพลิเคชัน
...
การเข้าสู่โหมด 'แก้ไข' จะช่วยให้คุณสามารถจัดระเบียบวิดเจ็ตได้ง่ายขึ้น ปรับแต่งวิดเจ็ต ลบวิดเจ็ต และเพิ่มวิดเจ็ตใหม่
...
วิดเจ็ตนี้ให้คุณมองเห็นภาพรวมของการบริโภคค่าใช้จ่ายต่าง ๆ ในภาพรวม
...
มันแสดงการบริโภคทั้งหมดสำหรับช่วงเวลาและสถานที่ที่กำหนดสำหรับแต่ละค่าใช้จ่าย และวิธีการเปรียบเทียบกับเบสไลน์ที่เลือก



มีวิดเจ็ตการเปรียบเทียบเบสไลน์ค่าใช้จ่าย 2 แบบ แต่ทั้งสองแบบทำงานในทางเดียวกัน
