...
เมื่อเข้าสู่โหมด 'แก้ไข' จะช่วยให้คุณสามารถจัดวิดเจ็ตได้ง่ายขึ้น ปรับแต่งวิดเจ็ต ลบวิดเจ็ต และเพิ่มวิดเจ็ตใหม่
...
เมื่อเข้าสู่โหมดแก้ไข คุณมีตัวเลือกดังนี้:
...
### การเปรียบเทียบเส้นฐานการใช้ประโยชน์

วิดเจ็ตนี้ให้คุณมองเห็นภาพรวมของการบริโภคประเภทสาธารณูปโภคต่าง ๆ ในภาพรวม
...
มันแสดงการบริโภครวมสำหรับช่วงเวลาที่กำหนดและสถานที่สำหรับแต่ละสาธารณูปโภค และวิธีการเปรียบเทียบกับเส้นฐานที่เลือก



มี 2 รูปแบบของวิดเจ็ตการเปรียบเทียบเส้นฐานการใช้ประโยชน์ แต่ทั้งสองทำงานในแบบเดียวกัน
...
เมื่อคุณปักการเปลี่ยนแปลง คุณกำลังบันทึกตัวกรองเหล่านั้นเพื่อให้โหลดทุกครั้งที่แดชบอร์ดโหลด
