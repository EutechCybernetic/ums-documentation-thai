...
วิดเจ็ตนี้ให้คุณมองเห็นภาพรวมของการใช้งานสาธารณูปโภคต่าง ๆ ในทันที
...
มันแสดงการใช้งานรวมสำหรับช่วงเวลาที่กำหนดและสถานที่สำหรับแต่ละสาธารณูปโภคและวิธีการเปรียบเทียบกับเบสไลน์ที่เลือก

มี 2 รูปแบบของวิดเจ็ตเปรียบเทียบเบสไลน์สาธารณูปโภค แต่ทั้งสองทำงานในทางเดียวกัน

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>

ใช้ตัวกรองสถานที่เพื่อเลือกสถานที่ที่คุณต้องการดูข้อมูลเปรียบเทียบ คุณจะเลือกอาคารหรือไซต์ที่นี่
