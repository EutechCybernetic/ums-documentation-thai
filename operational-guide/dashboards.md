...
{% hint style="info" %}
ถ้าคุณต้องการเปลี่ยนจำนวนของแดชบอร์ดที่มีหรือเปลี่ยนชื่อของแดชบอร์ด กรุณาติดต่อผู้จัดการบัญชี iviva ของคุณเพื่อขอความช่วยเหลือ
{% endhint %}

ถ้าผู้ใช้ต้องการแดชบอร์ดที่ปรับแต่งเอง สามารถสร้างหน้าตาของพอร์ทัลใหม่ให้กับพวกเขาใน iviva
...
มันแสดงการบริโภคทั้งหมดสำหรับช่วงเวลาที่กำหนดและสถานที่สำหรับแต่ละสาธารณูปโภค และวิธีการเปรียบเทียบกับเส้นฐานที่เลือก



มีการเปรียบเทียบเส้นฐานการใช้ประโยชน์วิดเจ็ต 2 แบบ แต่ทั้งสองแบบทำงานในทางเดียวกัน
