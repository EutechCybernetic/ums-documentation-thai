...
โปรดทราบว่าแดชบอร์ดเหล่านี้ถูกกำหนดค่าโดยผู้ใช้ที่เป็นผู้ดูแลระบบ และสามารถใช้ได้กับผู้ใช้ทั้งหมดที่มีสิทธิ์เข้าถึงแอปพลิเคชัน UMS

{% hint style="info" %}
หากคุณต้องการเปลี่ยนจำนวนของแดชบอร์ดที่มีอยู่ หรือเปลี่ยนชื่อของแดชบอร์ด กรุณาติดต่อผู้จัดการบัญชี iviva ของคุณเพื่อขอความช่วยเหลือ
{% endhint %}

หากผู้ใช้ต้องการแดชบอร์ดที่กำหนดเอง สามารถสร้างอินเทอร์เฟซพอร์ทัลใหม่ให้กับผู้ใช้ใน iviva
...
วิดเจ็ตนี้ให้เครื่องมือวิเคราะห์การบริโภคแบบเต็มรูปแบบในรูปแบบวิดเจ็ต
...
วิดเจ็ตนี้ให้คุณมองเห็นภาพรวมของการบริโภคค่าสาธารณูปโภคต่าง ๆ ที่คุณสามารถดูได้ทันที
...
วิดเจ็ตนี้แสดงการบริโภคทั้งหมดสำหรับช่วงเวลาและสถานที่ที่กำหนดสำหรับแต่ละค่าสาธารณูปโภค และวิธีการเปรียบเทียบกับเบสไลน์ที่เลือก



มีวิดเจ็ตการเปรียบเทียบเบสไลน์ค่าสาธารณูปโภค 2 รูปแบบ แต่ทั้งสองรูปแบบทำงานในทางเดียวกัน

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>

ใช้ตัวกรองสถานที่เพื่อเลือกสถานที่ที่คุณต้องการดูข้อมูลการเปรียบเทียบ โดยทั่วไปคุณจะเลือกอาคารหรือไซต์ที่นี่
...
คลิกที่ไอคอนนั้นเพื่อ 'ปัก' การเปลี่ยนแปลงที่วิดเจ็ตนี้
