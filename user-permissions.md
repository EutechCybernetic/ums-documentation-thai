...
บทบาทของแอปพลิเคชันที่มีให้ใช้งาน ได้แก่:
...
| ได้รับอนุญาตให้กำหนดค่าข้อมูล           | บทบาทนี้จำเป็นเพื่อให้ผู้ใช้สามารถกำหนดค่าข้อมูล - ซึ่งรวมถึงการกำหนดค่าของเมตร, เมตรเสมือน, กลุ่มเมตร, แท็ก, เส้นฐานและสถานที่                                                                                                              |
