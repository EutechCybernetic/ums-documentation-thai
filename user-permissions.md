...
ระบบจัดการสิ่งอำนวยความสะดวกปฏิบัติตามระบบควบคุมการเข้าถึงที่มีบทบาทตามมาตรฐาน iviva
...
| ได้รับอนุญาตให้กำหนดค่าข้อมูล           | บทบาทนี้จำเป็นสำหรับการเปิดใช้งานผู้ใช้เพื่อกำหนดค่าข้อมูล - ซึ่งรวมถึงการกำหนดค่าเมตร, เมตรเสมือน, กลุ่มเมตร, แท็ก, ฐานเปรียบเทียบและสถานที่                                                                                                              |
