...
{% hint style="info" %}
สิ่งนี้ใช้ได้เฉพาะสถานที่นั้น ไม่ใช่สถานที่ย่อยใดๆ คุณต้องทำแผนที่เมตรหลักแยกต่างหากสำหรับสถานที่ย่อย หากสถานที่ย่อยเหล่านั้นยังมีบอร์ดการแจกจ่ายหรือประเภทเมตรแม่อื่นๆ ในตัว
{% endhint %}